...
def unconfirmed():
    ...
    return render_template('admin/auth/unconfirmed.html')


@admin.route('/confirmed')
@login_required
...
def change_password():
    ...
    return render_template('admin/auth/change_password.html', form=form)
    ...
    if form.validate_on_submit():
        ...
        if user is not None:
            ...
            flash(_('An email with instructions to reset '
                  ...
                  'info')
        return redirect(url_for('admin.login'))
    return render_template('admin/auth/reset_password.html', form=form)
...
def change_email_request():
    ...
    if form.validate_on_submit():
        if current_user.verify_password(form.password.data):
            ...
            flash(_('Invalid email or password'), 'warning')
    return render_template('admin/auth/change_email.html', form=form)


@admin.route('/change-email/<token>', methods=['GET', 'POST'])
@login_required
